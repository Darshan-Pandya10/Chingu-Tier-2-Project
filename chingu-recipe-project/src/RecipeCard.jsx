...
function RecipeCard({ recipe, getRecipe }) {
  ...
  return (
    <div className="recipe-card p-2 min-h-[25rem] my-8 mx-5 rounded-lg">
      ...
      <button
        className="card-button mx-[0.2rem] py-2 px-0 flex items-center w-32 justify-around border-2 border-solid border-transparent text-base bg-transparent cursor-pointer mt-0 mx-2 mb-2  "
        onClick={() => {
          getRecipe(recipe);
        }}
      >
